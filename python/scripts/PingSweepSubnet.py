...
## Use socket to replace pythonping dependency.
...
pingSweep(cidrNetwork='127.0.0.0/8', pingTimeout= 0.03, numPings = 2) # Enter desired network here and run. 73.0.0.0/8 is Comcast btw
